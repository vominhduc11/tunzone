                ...
                >
                    <div className="bg-[#232c3b] rounded-2xl p-8 w-full max-w-md mx-auto">
                        ...
                        <p className="text-gray-400 mb-4">
                            Demo tài khoản: <b className="text-white">user</b> /{' '}
                            <b className="text-white">demo123</b>
                        </p>
                        <form onSubmit={handleLogin} className="space-y-4">
                            ...
                            {loginError && (
                                <div className="text-red-400 text-sm py-1">{loginError}</div>
                            )}
                            <button
                                type="submit"
                ...
                <div className="bg-[#232c3b] rounded-2xl shadow-lg p-8 grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div className="rounded-lg p-4">
                        <p className="text-gray-400 mb-2">
                            ...
                            <span className="font-medium text-white ml-2">XYZ000000</span> (không
                            đúng),
                            <span className="font-medium text-white ml-2">DEF654321</span> (hết
                            hạn).
                        </p>
                                    ...
                                    (() => {
                                        ...
                                        return days <= 60 ? (
                                            ...
                                            <p className="mt-4 text-yellow-300">
                                                Bạn có thể gia hạn trong vòng 60 ngày trước khi hết
                                                hạn.
                                            </p>
                                        );
                                    })()}
