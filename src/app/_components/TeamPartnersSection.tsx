      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-8 items-center mb-16">
          {partners.map(({ id, name, logo }) => (
            <div key={id} className="flex justify-center items-center p-4 bg-gray-800 rounded-lg hover:bg-gray-700 transition">
              <Image src={logo} alt={name} width={120} height={60} objectFit="contain" />
            </div>
          ))}
        </div>
      </div>
