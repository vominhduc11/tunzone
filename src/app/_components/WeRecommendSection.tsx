    ...
    return (
        <section className="bg-gray-700 py-16">
            <div className="container mx-auto text-center">
                <h2 className="text-4xl font-bold text-white mb-8">Sản phẩm nổi bật</h2>
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-5 gap-6 px-4">
                    {products.map((product, idx) => (
                        ...
                        >
                            <h3 className="text-xl font-semibold text-white mb-4 transition-colors duration-300 hover:text-blue-400">
                                {product.name}
                            </h3>
