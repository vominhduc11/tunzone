                                ...
                                <table className="min-w-full text-sm">
                                    <thead>
                                        <tr className="text-gray-300 bg-[#1e2530]">
                                            ...
                                            <th className="p-4 text-left font-semibold">Ngày mua</th>
                                    ...
                                    <tbody>
                                        {demoProducts.map((p, index) => (
                                            ...
                                            >
                                                ...
                                                <td className="p-4 text-gray-300">{p.purchaseDate}</td>
                                                <td className="p-4 text-gray-300">{p.expiryDate}</td>
                                                <td className="p-4">
                                                ...
                                                <td className="p-4">
                                                    {p.canRenew ? (
                                                        ...
                                                        <span className="text-gray-400 text-xs">Chưa đến thời gian gia hạn</span>
                                                    ) : (
                                                        <span className="text-gray-500 text-xs">Không thể gia hạn</span>
                                                    )}
                                                </td>
                                            </motion.tr>
                                        ))}
                                    ...
                                    <table className="min-w-full text-sm">
                                        <thead>
                                            <tr className="text-gray-300 bg-[#1e2530] rounded-lg">
                                                <th className="p-4 text-left font-semibold rounded-l-lg">Mã đơn</th>
                                                <th className="p-4 text-left font-semibold">Serial</th>
                                                <th className="p-4 text-left font-semibold">Loại</th>
                                                <th className="p-4 text-left font-semibold">Thời gian</th>
                                                <th className="p-4 text-left font-semibold">Thời hạn</th>
                                                <th className="p-4 text-left font-semibold">Giá</th>
                                                <th className="p-4 text-left font-semibold rounded-r-lg">Trạng thái</th>
                                            </tr>
                                        </thead>
                                        <tbody className="space-y-2">
                                            {demoOrders.map((o, index) => (
                                                ...
                                                >
                                                    ...
                                                    <td className="p-4 text-gray-300">{o.duration}</td>
                                                    <td className="p-4">
                                                        <span className="font-semibold text-yellow-400">{o.price}</span>
                                                    </td>
                                                    <td className="p-4">
                                                        <span className={`px-3 py-1 rounded-full text-xs font-semibold ${
                                                            o.status === "Hoàn tất" 
                        ...
                        >
                            ...
                            <div className="relative rounded-xl shadow-2xl bg-[#232c3b] border border-[#2b3445] max-w-2xl mx-auto overflow-hidden">
                                <div className="bg-gradient-to-r from-[#202837] to-[#232c3b] px-6 py-4 border-b border-[#2b3445]">
                                    ...
                                    <p className="text-gray-400 text-sm mt-1">Điền thông tin chi tiết để được hỗ trợ nhanh nhất</p>
                                </div>
                                <div className="p-6">
                                    <form className="space-y-6">
                                        ...
                                        >
                                            <label className="block text-gray-300 mb-2 font-medium">Chọn thiết bị</label>
                                            <div className="relative">
                                                <select className="w-full px-4 py-3 rounded-lg bg-[#181f2a] text-white border border-[#2b3445] focus:ring-2 focus:ring-cyan-400 focus:border-transparent transition-all duration-200 appearance-none">
                                                    {demoProducts.map((p) => (
                                                        <option key={p.serial} value={p.serial}>{p.name} ({p.serial})</option>
                                                    ))}
                                                </select>
                                        ...
                                        >
                                            <label className="block text-gray-300 mb-2 font-medium">Mô tả vấn đề</label>
                                            <textarea 
                                                rows={4} 
                                        ...
                                        >
                                            <label className="block text-gray-300 mb-2 font-medium">Tải lên hình ảnh (tuỳ chọn)</label>
                                            <div className="relative border-2 border-dashed border-[#2b3445] rounded-lg p-6 hover:border-cyan-400 transition-colors duration-200">
                                                ...
                                                <div className="text-center">
                                                    ...
                                                    <p className="mt-2 text-sm text-gray-400">
                                                        <span className="font-medium text-cyan-400">Nhấp để tải lên</span> hoặc kéo thả tệp vào đây
                                                    </p>
                ...
                >
                    ...
                    >
                        <div className="text-center mb-6">
                            ...
                            <h2 className="text-2xl font-bold text-cyan-400 mb-2">Gia hạn bảo hành</h2>
                        ...
                        <form className="space-y-6">
                            <div>
                                <label className="block text-gray-300 mb-2 font-medium">Thời gian gia hạn</label>
                                <div className="relative">
                                    <select className="w-full px-4 py-3 rounded-lg bg-[#181f2a] text-white border border-[#2b3445] focus:ring-2 focus:ring-cyan-400 focus:border-transparent transition-all duration-200 appearance-none">
